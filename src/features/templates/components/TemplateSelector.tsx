...
const TemplateCard = React.memo(({ 
    ...
    return (
        ...
        >
            ...
            <div className="relative w-full aspect-[1/1.414] rounded-[2.5rem] overflow-hidden border border-slate-200/50 dark:border-white/5 bg-white dark:bg-slate-950 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] dark:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.3)] group-hover:shadow-2xl transition-all duration-500">
                ...
                <div className="absolute inset-4 rounded-[1.8rem] overflow-hidden border border-slate-100 dark:border-white/5 bg-slate-50 dark:bg-black/20">
                    <LayoutPreview
                        layoutId={layout.id as "classic" | "modern" | "minimal"}
                        className="w-full h-full border-0 pointer-events-none transform scale-[1.01]"
                    />
                </div>
...
export function TemplateSelector({ onSelect, onClose }: TemplateSelectorProps) {
    ...
    return (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 md:p-8 lg:p-12 overflow-y-auto mesh-gradient">
            ...
            <div className="w-full max-w-7xl flex flex-col gap-16 py-12 md:py-24">
                    ...
                    {isLoading ? (
                        [...Array(3)].map((_, i) => (
                            <div key={i} className="space-y-6">
                                ...
                                <Skeleton className="w-full aspect-[1/1.414] rounded-[2.5rem]" />
                            </div>
                        ))
                    ) : error ? (
                        <motion.div 
