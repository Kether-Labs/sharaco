...
import { ChevronLeft, Save, Minus, Plus, Maximize, CheckCircle2, Loader2, AlertCircle, Edit3, MoreVertical } from "lucide-react";
                ...
                <DropdownMenu open={showActions} onOpenChange={setShowActions}>
                    ...
                    >
                        <DropdownMenuGroup className="p-1">
                            ...
                            <DropdownMenuItem className="flex flex-col items-start gap-0.5 p-3 focus:bg-white/5 rounded-xl cursor-pointer group">
                                <div className="flex items-center justify-between w-full">
                                    <div className="flex items-center gap-2">
                                    ...
                                    <DropdownMenuShortcut className="text-zinc-600">⌘E</DropdownMenuShortcut>
                                </div>
